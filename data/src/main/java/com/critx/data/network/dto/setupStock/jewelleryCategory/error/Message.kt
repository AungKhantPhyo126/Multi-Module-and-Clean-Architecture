...
data class Message(
    ...
    val gem_value: List<String?>?,

    @SerializedName("bookmark.image")
    val bookMarkImage: List<String?>?,

    @SerializedName("order.goldsmith_id")
...
fun Message.getMessage(): List<String?> {
    return avg_wastage_per_unit_kpy ?: avg_weight_per_unit_gm ?: designs ?: group_id ?: images
    ?: jewellery_quality_id ?: jewellery_type_id ?: name ?: order_to_goldsmith ?: specification
    ?: video ?: related_categories ?: product_code ?: repair_stocks ?: amount ?: gold_box_id

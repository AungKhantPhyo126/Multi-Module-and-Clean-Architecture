...
@HiltViewModel
class TransferStockViewModel @Inject constructor(
    ...
    private var _matchStock = MutableLiveData<Resource<CheckUpUiModel>>()
    val matchStockLive: LiveData<Resource<CheckUpUiModel>>
        get() = _matchStock
    fun resetCheckUpStockLive(){
        _matchStock.value= null
    }
